...
public class Consumer {
    ...
    public Consumer(int port, int numThreads, String destination) {
        ...
        this.server = ServerBuilder.forPort(port)
                .addService(new FileTransferServiceImpl(destination))
                .executor(executor)
                .build();
    }
    ...
    private static class FileTransferServiceImpl extends FileTransferServiceGrpc.FileTransferServiceImplBase {
        private final Path destination;

        public FileTransferServiceImpl(String destination) {
